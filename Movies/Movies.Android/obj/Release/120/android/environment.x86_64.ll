...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"3d60428d-4d4f-45e7-9021-7438adc211fa\00", align 16
@__app_environment_variables_n_2.4 = internal constant [28 x i8] c"XA_HTTP_CLIENT_HANDLER_TYPE\00", align 16
@__app_environment_variables_v_2.5 = internal constant [41 x i8] c"Xamarin.Android.Net.AndroidClientHandler\00", align 16
@__app_environment_variables_n_3.6 = internal constant [16 x i8] c"XA_TLS_PROVIDER\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [15 x i8] c"com.gml.Movies\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555355, ; android_runtime_jnienv_class_token
	i32 100674033, ; jnienv_initialize_method_token
	i32 100674032, ; jnienv_registerjninatives_method_token
	...
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__ApplicationConfig_android_package_name.0, i32 0, i32 0); android_package_name
}, align 8
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [70 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
