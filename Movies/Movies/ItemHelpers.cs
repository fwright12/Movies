...
#if true
        public static async Task<bool> Evaluate(ChainLink<EventArgsAsyncWrapper<IEnumerable<DatastoreKeyReadArgs<Uri>>>> controller, Item item, FilterPredicate filter)
        {
