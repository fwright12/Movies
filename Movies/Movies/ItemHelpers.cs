...
#if true
        public static async Task<bool> Evaluate(ChainLink<EventArgsAsyncWrapper<IEnumerable<DatastoreKeyValueReadArgs<Uri>>>> controller, Item item, FilterPredicate filter)
        {
